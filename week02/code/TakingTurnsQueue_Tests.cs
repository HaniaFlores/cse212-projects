...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with more than 1 turn are only allowed one re-entry
    ...
    // Defect(s) Found: Persons are prematurely excluded after just one turn.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Infinite people are not correctly re-added or their state is modified incorrectly.
    ...
    // Defect(s) Found: Turns are incorrectly handled for infinite players.
